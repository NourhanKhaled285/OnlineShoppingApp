...
public class Shopingview3 extends AppCompatActivity {
...
//        database.insert1();
        ...
        text = new TextWatcher(){
            ...
            public void afterTextChanged(Editable s) {
                if (et2.getText().toString().isEmpty()){
                    arr.clear();
                    Cursor res = database.getspesificcategory(3);
                    //  arr.clear();
        ...
        bt6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(Shopingview3.this, ScanQR.class);
                startActivity(i);
            }
        });
        ...
        bt4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Shopingview3.this, Cart.class);
