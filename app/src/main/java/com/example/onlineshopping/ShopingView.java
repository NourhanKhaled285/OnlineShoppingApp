...
public class ShopingView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shoping_view);
        ...
        text = new TextWatcher(){
            ...
            public void afterTextChanged(Editable s) {
                if ((et2.getText().toString()).isEmpty()){
                    arr.clear();
                    Cursor res = database.getspesificcategory(1);
                    //  arr.clear();
        ...
        bt6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(ShopingView.this, ScanQR.class);
                startActivity(i);
        ...
        bt4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ShopingView.this, Cart.class);
